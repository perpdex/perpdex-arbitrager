...
@pytest.mark.parametrize(
    ids=[
        # pos == 0
        "no pos, spread == 0 -> stay",
        "no pos, spread > 0, spread < close_threshold < open_threshold -> stay 0",
        "no pos, spread > 0, close_threshold < spread < open_threshold -> stay 0",
        "no pos, spread > 0, close_threshold < spread == open_threshold -> stay 0",
        "no pos, spread > 0, close_threshold < open_threshold < spread -> open",
        "no pos, spread > 0, close_threshold < open_threshold << spread -> open more",

        # pos > 0
        "pos 10, spread > 0, spread < close_threshold < open_threshold -> close 10",
        "pos 10, spread > 0, close_threshold < spread < open_threshold -> stay 10",
        "pos 10, spread > 0, close_threshold < spread == open_threshold -> stay 10",
        "pos 10, spread > 0, close_threshold < open_threshold < spread -> stay 10",
        "pos 10, spread > 0, close_threshold < open_threshold << spread -> add more",

        "pos 7(abs pos < lot_size), spread > 0, spread < close_threshold < open_threshold -> close 7",
        "pos 7(abs pos < lot_size), spread > 0, close_threshold < spread < open_threshold -> stay 7",
        "pos 7(abs pos < lot_size), spread > 0, close_threshold < spread == open_threshold -> stay 7",
        "pos 7(abs pos < lot_size), spread > 0, close_threshold < open_threshold < spread -> open",
        "pos 7(abs pos < lot_size), spread > 0, close_threshold < open_threshold << spread -> add more",
